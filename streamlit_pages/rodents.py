...
def show():
    ...
    st.markdown("### Monthly 311 Rodent Complaints in NYC (2020–2025)")
    ...
    st.markdown("### Total 311 Rodent Complaints by Borough (2020-2025)")
    chart2 = bar2_chart()
    ...
    st.markdown("### Rodent Complaint Types by Borough (2020–2025)")
    chart3 = bar3_chart()
